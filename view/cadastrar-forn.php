                ...
                <fieldset class="box-form"><legend>Novo Fornecedor</legend>
                    ...
                    <div class="vertical">
                        ...
                        <div class="horizontal w40">
                            ...
                            <input type="text" name="tRazao" id="cRazao" size="30" maxlength="100" placeholder="Digite a razão" required autofocus/></p>
                        </div>
                        <div class="horizontal w40">
                    ...
                    <div class="vertical">
                        ...
                        <div class="horizontal w40">
                            ...
                            <input type="text" name="tEndereco" id="cEndereco" size="50" maxlength="40" placeholder="Digite o Endereço" required autofocus/></p>
                        </div>
